...
@section('title','AddVenue')

@section('header','NewVenue')
...
<section class="content">
  <div class="row">
      ...
      <div class="col-md-6">
        <div class="add-new">
          <a href="{{ route('admin.venues.index')}}" class="btn btn-success"><i class="fa fa-list-ul" aria-hidden="true"></i> &nbsp;Package List</a>
        </div>
      </div>
    </div>
<hr/>
